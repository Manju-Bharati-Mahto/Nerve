...
export function passwordOtpEmail(name: string, otp: string): string {
  return `
    <div style="font-family:sans-serif;max-width:480px;margin:auto;padding:24px">
      <h2 style="color:#1a1a1a">Your Password Reset Code</h2>
      <p>Hi ${name || "there"},</p>
      <p>Use the code below to reset your Parul University Knowledge Hub password. It expires in <strong>10 minutes</strong>.</p>
