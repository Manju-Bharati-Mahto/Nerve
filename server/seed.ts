...
export const BUILT_IN_TEAMS: SeedTeam[] = [
  ...
  { id: "media", name: "Media Crew", color: "green", isBuiltIn: true },
...
export const SEED_USERS: SeedUser[] = [
  ...
  },
  {
    ...
    email: "media-lead@parul.ac.in",
    password: "medialead123",
    department: "Media Crew",
    role: "sub_admin",
    team: "media",
    managed_by: null,
  },
  {
    ...
    email: "media-user@parul.ac.in",
    password: "mediauser123",
    department: "Media Crew",
    role: "user",
    team: "media",
    managed_by: "mol-001",
