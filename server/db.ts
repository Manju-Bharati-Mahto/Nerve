...
export async function bootstrapDatabase() {
  ...
  await pool.query(`
    CREATE TABLE IF NOT EXISTS users (
      ...
      role TEXT NOT NULL CHECK (role IN ('super_admin', 'admin', 'sub_admin', 'user', 'outreach_manager', 'outreach_editor', 'outreach_publisher', 'branding_reports_admin', 'design_reports_admin', 'task_owner', 'task_manager')),
  ...
  await pool.query(`
    ...
    BEGIN
      ...
      ALTER TABLE users ADD CONSTRAINT users_role_check
        CHECK (role IN ('super_admin', 'admin', 'sub_admin', 'user', 'outreach_manager', 'outreach_editor', 'outreach_publisher', 'branding_reports_admin', 'design_reports_admin', 'task_owner', 'task_manager'));
    END $$;
  `);
